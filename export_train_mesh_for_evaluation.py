...
def export(mesh_file, agg_file, seg_file, label_map_file, type, output_file, json_name):
    ...
    if type == 'label':
        ...
        util_3d.export_instance_ids_for_eval(output_file, label_ids, instance_ids, json_name)
    else:
        raise
